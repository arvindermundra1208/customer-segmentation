...
\begin{titlepage}
  ...
  % {\large\textbf{STAT 654: Statistical Computing with R and Python}\\[0.3cm]
...
Arvinder Mundra \,|\, 335007465\\[0.3cm]}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_024_01.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_027_02.png}
...
\begin{figure}[!t]
  \centering
  \includegraphics[width=0.65\textwidth]{figures/fig_034_04.png}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_036_05.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_039_06.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_046_07.png}
...
The PCA biplot confirms that PC1 provides a clear separation between high- and
low-value customers, with Frequency, Monetary, and Customer\_Lifetime\_Days aligned
along the positive direction.  PC2, driven by Avg\_Order\_Value and Avg\_Quantity,
captures basket-size behaviour independently of overall engagement.  The loading
heatmap is consistent with Table~\ref{tab:pca_loadings}, showing strong contributions
of these variables to the first two components.
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/fig_047_08.png}
...
Figure~\ref{fig:kmeans} shows that the three K-Means clusters are primarily separated
along PC1, indicating that overall customer value is the dominant segmentation driver.
The cluster occupying the high-PC1 region corresponds to customers with high frequency
and monetary contribution, while the remaining clusters lie in lower-value regions.
The limited overlap between clusters supports the choice of $k=3$.
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{figures/fig_054_10.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_051_09.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_059_11.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_071_14.png}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/fig_084_15.png}
...
\begin{enumerate}[leftmargin=*]
  ...
  \item Open \texttt{STAT654\_Final\_Project.ipynb} in
